...
ALTER TABLE `secretaria` ADD FOREIGN KEY (`cnpj`) REFERENCES `senac` (`cnpj`);

ALTER TABLE `turma` ADD FOREIGN KEY (`id_aluno`) REFERENCES `aluno` (`id_aluno`);

ALTER TABLE `turma` ADD FOREIGN KEY (`cnpj`) REFERENCES `senac` (`cnpj`);
...
ALTER TABLE `funcionarios` ADD FOREIGN KEY (`cnpj`) REFERENCES `senac` (`cnpj`);
